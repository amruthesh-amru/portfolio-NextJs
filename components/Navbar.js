...
export default function Navbar() {
  ...
  const styles = {
    background: 'conic-gradient(from 90deg at 50% 50%,#f25656 0deg,#fbd03b 80deg,#56c4f5 208deg,#c156c2 330deg,#f25656 1turn)'
    // background: 'linear-gradient(to bottom right, #56c4f5, #e879f9, #f43f5e, #34d399, #2dd4bf, #a855f7, #06b6d4)'
  };
    ...
    <div className="max-w-6xl mx-auto px-4 py-10 md:py-20">
      <div className="flex md:flex-row justify-between items-center">
        <div className="flex flex-col">
          <Link href="/">
            <h1 style={styles} className="px-3 py-[8px] rounded font-bold text-lg sm:text-2xl text-gray-900">
              {userData.name}
            </h1>
          </Link>
        </div>
